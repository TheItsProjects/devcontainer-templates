...
-   TeX Live environment with essential LaTeX packages installed
-   Pre-configured VS Code settings for LaTeX editing
-   Automatic PDF building using latexmk
-   VS Code extension for LaTeX Workshop for advanced features
